...
让十位历史人物各自吃进同一份人格提示词模板，再把名字、时代、知识体系、语言风格和核心思想替换成自己的版本，随后独立发言、彼此辩论，最后才总结出行动方案。
...
请展示每位入选人物的人格提示词摘要、共享模板如何被实例化、各自发言，以及他们的圆桌辩论。
```
...
- 内部会真的按人物人格提示词推理
- 外部不会直接把提示词生硬吐出来
- 最终展示给你的，是翻译成现代中文、但仍然保留人物判断方式的发言
- 如果发言晦涩、像模板，说明渲染失败，需要重写
...
- 现在是“一个共享模板 + 10 个自动替换后的智者实例”，不是 10 个松散视角
